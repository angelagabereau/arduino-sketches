/*
 ...
 SD Logger
 This sketch is used to develop and debug the shield and library.
 To use, enable logging of a sensor, set relevant pin to true.
...
void loopSoundSensor(){
  int val;
  val=analogRead(SOUNDPIN);   //connect mic sensor to Analog Sound Pin
  Serial.println();
...
void loopSoilSensor(){
  int val;
  val=analogRead(SOILPIN);   //connect mic sensor to Analog Sound Pin
  //Serial.println();
...
void loopLightSensor(){
  int val;
  val=analogRead(LIGHTPIN);   //connect mic sensor to Analog Sound Pin
  //Serial.println();
...
void loopGasSensor(){
  int val;
  val=analogRead(GASPIN);   //connect mic sensor to Analog Sound Pin
  //Serial.println();
